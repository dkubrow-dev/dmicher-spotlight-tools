...
Help now uses the Generics interface: a collapsible tree, resizable navigation and pinned author, thanks and dmicher modules pages. The last page briefly describes all five suite components; content remains in Spotlight. Short Russian and English pages explain table actions. Question icons beside GM, personal card, volume and audit settings open the relevant page and section, including explanations for locked Premium fields. Players can also open Help.

Обновлённый Generics убирает подчёркивание вопросиков и располагает их поверх угла U/I/B, сохраняя размер кнопок и отдельное действие справки. Правая кнопка переносит каскад прилипших окон; «Сохранить» в общих настройках оформления оставляет окно открытым. Справка Spotlight описывает это поведение на обоих языках.
