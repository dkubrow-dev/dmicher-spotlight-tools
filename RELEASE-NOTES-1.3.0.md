...
Справка переведена на общий интерфейс Generics: раскрываемое дерево, изменяемая ширина меню и закреплённые внизу страницы автора, благодарностей и Premium. Краткие страницы на русском и английском описывают действия за столом; содержание остаётся в Spotlight. Вопросики возле настроек мастера, личных карточек, громкости и аудита открывают соответствующую страницу и раздел, в том числе для временно недоступных премиальных полей. Справка доступна также игрокам.

Help now uses the Generics interface: a collapsible tree, resizable navigation and pinned author, thanks and Premium pages. Short Russian and English pages explain table actions; content remains in Spotlight. Question icons beside GM, personal card, volume and audit settings open the relevant page and section, including explanations for locked Premium fields. Players can also open Help.
